...
(function() {
  ...
  Bottleneck = (function() {
    ...
    if (!Bottleneck.prototype.Promise) {
      Bottleneck.prototype.Promise = (function() {
        var error1;
        try {
          ...
          return typeof Promise !== "undefined" && Promise !== null ? Promise : function() {
            throw new Bottleneck.prototype.BottleneckError("NO_PROMISE_SUPPORT", "Bottleneck: install 'bluebird' or use Node 0.12 or higher for Promise support");
          };
        }
      })();
    }
    ...
    Bottleneck.prototype._trigger = function(name, args) {
      ...
      if (name === "dropped" && this.rejectOnDrop) {
        dropped = args[0];
        dropped.cb(new Bottleneck.prototype.BottleneckError("JOB_DROPPED", "This job has been dropped."));
      }
      ...
      return new Bottleneck.prototype.Promise((function(_this) {
        return function(resolve, reject) {
          return _this.submitPriority.apply({}, Array.prototype.concat(priority, wrapped, function() {
            ...
            if (error != null) {
              return reject.apply({}, [error].concat(args));
            } else {
              return resolve.apply({}, args);
            }
          }));
        };
      })(this));
